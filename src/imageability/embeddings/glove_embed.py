...
MODEL_SAVE_PATH = "glove_imageability_model.pkl"
...
embedding_model = api.load("glove-wiki-gigaword-100")  # Example with GloVe 100-dim
...
# ================================
# 3. Save the Embeddings Using NumPy's .npz Format
# ================================

# Save words and embeddings in a compressed .npz file
np.savez_compressed(
    "data/imageability/glove_embeddings.npz",
